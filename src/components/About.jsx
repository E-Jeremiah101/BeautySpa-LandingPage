          ...
          >
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-700">
                At our spa, we believe in providing a sanctuary where
                tranquility and luxury meet. With a team of skilled
                practitioners and a serene atmosphere, we cater to your
                relaxation and wellness needs. Our services are designed to
                rejuvenate your body and mind, leaving you refreshed and
                revitalized
              </p>
          ...
          <div class="img-bg flex items-center md:px-10 ">
            <div className="bg-white/40 md:h-[65vh] h-full w-full md:w-150 md:block flex md:pl-10 md:py-5 items-center justify-center">
              <div className="md:w-100">
                <h2
                  className="mb-10 "
                  class="about-sub2 service active-service"
                >

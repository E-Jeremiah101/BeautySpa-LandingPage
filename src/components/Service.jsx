          ...
          <div className=" md:w-fit  grid md:grid-cols-3 md:gap-4 gap-8  object-cover mt-3">
            <div className="md:w-63 w-97">
              ...
              <span className="text-gray-700 text-sm leading-4 block">
                Indulge in the ultimate hand and foot care for perfectly
                polished nails.
              </span>
            </div>
            <div className="md:w-63 w-97">
              ...
              <span className="text-gray-700 text-sm leading-4 block">
                Revitalize your skin with our customized facial therapies
            ...
            <div className="md:w-63 w-97">
              ...
              <span className="text-gray-700 text-sm leading-4 block">
                Experience the therapeutic effects of essential oils combined
                with soothing massage techniques
              </span>
            </div>
          </div>
        </div>
